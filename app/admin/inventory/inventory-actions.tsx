...
export function InventoryActions() {
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <button className="bg-gradient-to-r from-[#d0bcff] to-[#e9ddff] px-6 py-3 rounded-lg text-[#3c0091] text-xs font-bold uppercase tracking-wider flex items-center gap-2 shadow-[0_4px_14px_0_rgba(139,92,246,0.39)] hover:opacity-90 transition-opacity active:scale-95">
