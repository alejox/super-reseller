import { Search, Filter, MoreVertical, Edit, AlertTriangle, Eye } from "lucide-react";
import { InventoryActions } from "./inventory-actions";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "StreamPanel - Account Inventory",
};
    ...
    <div className="p-10 max-w-[1440px] mx-auto w-full space-y-12">
      ...
      <div className="bg-[#131b2e] border border-[#494454] rounded-xl overflow-hidden shadow-lg">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-[#494454]/50 bg-[#131b2e]">
              ...
              {/* Row 1 */}
              <tr className="hover:bg-[#171f33] transition-colors group">
                <td className="py-4 px-6">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded bg-red-600/20 text-red-500 flex items-center justify-center font-bold text-sm">N</div>
                    <span className="text-sm text-[#dae2fd] font-medium">Netflix 4K</span>
                  </div>
                </td>
                <td className="py-4 px-6 text-sm text-[#cbc3d7]">user123@example.com</td>
                <td className="py-4 px-6 text-sm text-[#cbc3d7]">
                  <div className="flex items-center gap-2">
                    ••••••••
                    <button className="text-[#d0bcff] hover:text-[#e9ddff] opacity-0 group-hover:opacity-100 transition-opacity">
                      <Eye className="w-4 h-4" />
                    </button>
                  </div>
                </td>
                <td className="py-4 px-6 text-sm text-[#cbc3d7]">Profile 2</td>
                <td className="py-4 px-6 text-sm text-[#cbc3d7]">2024-12-15</td>
                <td className="py-4 px-6">
              ...
              <tr className="hover:bg-[#171f33] transition-colors group">
                <td className="py-4 px-6">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded bg-blue-600/20 text-blue-500 flex items-center justify-center font-bold text-sm">D+</div>
                    <span className="text-sm text-[#dae2fd] font-medium">Disney+ Prem</span>
                  </div>
                </td>
                <td className="py-4 px-6 text-sm text-[#cbc3d7]">cinema.lover@mail.com</td>
                <td className="py-4 px-6 text-sm text-[#cbc3d7]">
                  <div className="flex items-center gap-2">
                    ••••••••
                    <button className="text-[#d0bcff] hover:text-[#e9ddff] opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <td className="py-4 px-6 text-sm text-[#cbc3d7]">Main</td>
                <td className="py-4 px-6 text-sm text-[#cbc3d7]">2024-06-30</td>
                <td className="py-4 px-6">
              ...
              <tr className="hover:bg-[#171f33] transition-colors group">
                <td className="py-4 px-6">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded bg-green-500/20 text-green-500 flex items-center justify-center font-bold text-sm">Sp</div>
                    <span className="text-sm text-[#dae2fd] font-medium">Spotify Fam</span>
                  </div>
                </td>
                <td className="py-4 px-6 text-sm text-[#cbc3d7]">music.bot99@tech.com</td>
                <td className="py-4 px-6 text-sm text-[#cbc3d7]">
                  <div className="flex items-center gap-2">
                    ••••••••
                    <button className="text-[#d0bcff] hover:text-[#e9ddff] opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <td className="py-4 px-6 text-sm text-[#cbc3d7]">Invite Link</td>
                <td className="py-4 px-6 text-sm text-[#ffb4ab]">2023-11-01</td>
                <td className="py-4 px-6">
              ...
              <tr className="hover:bg-[#171f33] transition-colors group">
                ...
                <td className="py-4 px-6 text-sm text-[#cbc3d7]">admin.sub@network.io</td>
                <td className="py-4 px-6 text-sm text-[#cbc3d7]">
                  <div className="flex items-center gap-2">
                    ••••••••
                    <button className="text-[#d0bcff] hover:text-[#e9ddff] opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <td className="py-4 px-6 text-sm text-[#cbc3d7]">Profile 5</td>
                <td className="py-4 px-6 text-sm text-[#cbc3d7]">2025-01-22</td>
                <td className="py-4 px-6">
                  <span className="px-3 py-1 rounded-full bg-green-500/15 text-green-400 text-[10px] font-semibold uppercase tracking-wider inline-flex items-center gap-1 border border-green-500/20">
                    <span className="w-1.5 h-1.5 rounded-full bg-green-400"></span> Available
                  </span>
        ...
        <div className="p-4 border-t border-[#494454] bg-[#171f33] flex items-center justify-between">
          <span className="text-sm text-[#cbc3d7]">Showing 1 to 4 of 240 entries</span>
          <div className="flex gap-2">
            ...
            <button className="px-3 py-1 rounded border border-[#494454] text-[#cbc3d7] hover:bg-[#2d3449]">2</button>
            <button className="px-3 py-1 rounded border border-[#494454] text-[#cbc3d7] hover:bg-[#2d3449]">3</button>
            <span className="px-2 py-1 text-[#cbc3d7]">...</span>
            <button className="px-3 py-1 rounded border border-[#494454] text-[#cbc3d7] hover:bg-[#2d3449]">Next</button>
          </div>
        </div>
      </div>
